...
public class Result implements org.apache.thrift.TBase<Result, Result._Fields>, java.io.Serializable, Cloneable, Comparable<Result> {
  ...
  private static final org.apache.thrift.protocol.TField RESULTFILE_FIELD_DESC = new org.apache.thrift.protocol.TField("resultfile", org.apache.thrift.protocol.TType.STRING, (short)3);
  ...
  public ByteBuffer resultfile; // optional
  ...
  private static final _Fields optionals[] = {_Fields.RESULTFILE};
  ...
  static {
    ...
    tmpMap.put(_Fields.RESULTFILE, new org.apache.thrift.meta_data.FieldMetaData("resultfile", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public Result(Result other) {
    ...
    if (other.isSetResultfile()) {
      this.resultfile = org.apache.thrift.TBaseHelper.copyBinary(other.resultfile);
    }
  }
  ...
  public byte[] getResultfile() {
    setResultfile(org.apache.thrift.TBaseHelper.rightSize(resultfile));
    return resultfile == null ? null : resultfile.array();
  }

  public ByteBuffer bufferForResultfile() {
    return org.apache.thrift.TBaseHelper.copyBinary(resultfile);
  }

  public Result setResultfile(byte[] resultfile) {
    this.resultfile = resultfile == null ? (ByteBuffer)null : ByteBuffer.wrap(Arrays.copyOf(resultfile, resultfile.length));
    return this;
  }

  public Result setResultfile(ByteBuffer resultfile) {
    this.resultfile = org.apache.thrift.TBaseHelper.copyBinary(resultfile);
    return this;
  }
  ...
  /** Returns true if field resultfile is set (has been assigned a value) and false otherwise */
  public boolean isSetResultfile() {
    return this.resultfile != null;
  }

  public void setResultfileIsSet(boolean value) {
    if (!value) {
      this.resultfile = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULTFILE:
      if (value == null) {
        ...
        setResultfile((ByteBuffer)value);
      }
      break;
  ...
  public boolean equals(Result that) {
    ...
    boolean this_present_resultfile = true && this.isSetResultfile();
    boolean that_present_resultfile = true && that.isSetResultfile();
    if (this_present_resultfile || that_present_resultfile) {
      if (!(this_present_resultfile && that_present_resultfile))
        return false;
      if (!this.resultfile.equals(that.resultfile))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_resultfile = true && (isSetResultfile());
    list.add(present_resultfile);
    if (present_resultfile)
      list.add(resultfile);
  ...
  public int compareTo(Result other) {
    ...
    lastComparison = Boolean.valueOf(isSetResultfile()).compareTo(other.isSetResultfile());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetResultfile()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.resultfile, other.resultfile);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetResultfile()) {
      ...
      if (this.resultfile == null) {
        ...
        org.apache.thrift.TBaseHelper.toString(this.resultfile, sb);
      }
      first = false;
    }
    sb.append(")");
  ...
  private static class ResultStandardScheme extends StandardScheme<Result> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Result struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // RESULTFILE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.resultfile = iprot.readBinary();
              struct.setResultfileIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Result struct) throws org.apache.thrift.TException {
      ...
      if (struct.resultfile != null) {
        if (struct.isSetResultfile()) {
          oprot.writeFieldBegin(RESULTFILE_FIELD_DESC);
          oprot.writeBinary(struct.resultfile);
          oprot.writeFieldEnd();
        }
      }
